...
$('<script src="https://rawcdn.githack.com/Alistair1231/Kittens-Game-automation-and-tools/f992dc8/kittens.js"></script>').insertBefore("div[id*='gamePageContainer']");
...
$("<a href='#' onclick='bot.export()'>Export</a><span> </span><a href='#' onclick='bot.import()'>Import</a><span> | </span>").insertBefore("a[onclick*='bot.start(1)']");